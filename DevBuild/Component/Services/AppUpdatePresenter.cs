...
namespace Srushti.Updates
{
    ...
    public class AppUpdatePresenter
    {
        ...
        /// <summary>
        /// Raised when download of *all* update files from update server is finished,
        /// </summary>
        ...
        private string _LocalConfigFilePath = string.Empty;
        private string _RemoteConfigFilePath = string.Empty;

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="view">Instance of winform implementing IView</param>
        public AppUpdatePresenter(IView view, string localProductConfigFilePath,
            string onlineProductConfigFilePath)
        {
            _LocalConfigFilePath = localProductConfigFilePath;
            _RemoteConfigFilePath = onlineProductConfigFilePath;
        ...
        /// update operation.
        /// The logical sequence of method call is as follows.
        /// 1. InitiateUpdateActivities() - call from UI window.
        ///     - Online presence of update files will be checked asynchronously.
        /// 2. StartFileDownload() - Invoked by a helper_UpdateFilesCheckCompleted() event handler.
        ///     - Download update files asynchronously.
        /// 3. ContinueAfterUpdateFilesDownlad() - Invoked by helper_FilesDownloadCompleted() event handler.
        /// </summary>
        public void InitiateUpdateActivities()
        {
            try
            {
                ...
                if (helper.IsUpdateRequired(_LocalConfigFilePath, _RemoteConfigFilePath))
                {
        ...
        private void ContinueAfterUpdateFilesDownload()
        {
            try
            {
                //Check pre and post DLLs can instantiated
                helper.CheckPrePostFilesAvailability();
                ...
                helper.SaveOnlineConfigToLocal(_LocalConfigFilePath);
